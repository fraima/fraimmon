...
// func Testutil.UrlTreatment(t *testing.T) {
// 	type args struct {
// 		uri string
// 	}
// 	tests := []struct {
...
// 			got, got1 := util.UrlTreatment(tt.args.uri)
// 			if !reflect.DeepEqual(got, tt.want) {
// 				t.Errorf("util.UrlTreatment() got = %v, want %v", got, tt.want)
// 			}
// 			if got1 != tt.want1 {
// 				t.Errorf("util.UrlTreatment() got1 = %v, want %v", got1, tt.want1)
// 			}
// 		})
// 	}
// }
